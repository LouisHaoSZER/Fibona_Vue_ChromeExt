...
<template>
  <main class="p-3 w-50">
    <div
      class=" text-xl font-bold mb-3 pb-1"
    ...
    <select
      id="language"
      class="block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded  mb-3 leading-tight focus:outline-none focus:bg-white" name=""
    >
      <option
